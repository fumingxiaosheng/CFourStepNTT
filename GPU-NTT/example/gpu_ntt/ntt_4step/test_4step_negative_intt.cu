...
{
    printf("hxw negative intt test ops\n");
...
#error "Please define reduction type."
    ...
    {
        ntt_result[i] = generator.negative_intt(input1[i]);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    vector<Root_> psitable1 =
        parameters.gpu_root_of_unity_table_generator(parameters.negative_2n1_based_inverse_root_of_unity_table);//ROOT_是根据约减类型而定的数据类型，注意在param宏宏,root是data类型的
    ...
    vector<Root_> psitable2 =
        parameters.gpu_root_of_unity_table_generator(parameters.negative_n2_based_inverse_root_of_unity_table);
    ...
    THROW_IF_CUDA_ERROR(cudaMemcpy(W_Table_device, parameters.negative_W_inverse_root_of_unity_table.data(),
