...
#error "Please define reduction type."
    ...
    {
        ntt_result[i] = generator.intt(input1[i]); //这里对应着求逆的结果
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int j = 0; j < BATCH; j++)
    {
        /*vector<Data> cpu_intt_transposed_input = generator.intt_first_transpose(input1[j]);  // INTT TRANSPOSE IN CPU 
    ...
    GPU_4STEP_NTT(Input_Datas, Output_Datas, psitable_device1, psitable_device2, W_Table_device,
                  test_modulus, cfg_intt, BATCH, 1);//求逆时,Input_Datas是n1*n2维度的矩阵
