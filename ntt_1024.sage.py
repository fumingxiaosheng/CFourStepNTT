# This file was *autogenerated* from the file ntt_1024.sage dev4 look look

#new path 222 33
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_5 = Integer(5); _sage_const_12289 = Integer(12289)#计算a*b mod Zq/x^n+1
def polymul(a, b, n, q):
...
if __name__ == "__main__":
    ...
    n1 = _sage_const_2 **_sage_const_5 
    ...
    b = []
    for i in range(n):
        b.append(Zq(_sage_const_0 ))

    root_n = Zq(get_root_of_unity(n, q))

    root_2n = Zq(get_root_of_unity(_sage_const_2  * n, q)) #计算Zq上的2n次本原单位根
