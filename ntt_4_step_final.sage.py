...
# This file was *autogenerated* from the file ntt_4_step_final.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_12 = Integer(12); _sage_const_576460752303415297 = Integer(576460752303415297)#计算a*b mod Zq/x^n+1
def polymul(a, b, n, q):
...
if __name__ == "__main__":
    ...
    q = _sage_const_576460752303415297 
    assert(q % (_sage_const_2 *n) == _sage_const_1 )
    print("通过测试")
    root_2n = Zq(get_root_of_unity(_sage_const_2  * n, q))
    print(root_2n)
